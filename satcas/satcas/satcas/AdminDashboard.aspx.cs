...
namespace satcas
{
    public partial class AdminDashboard : System.Web.UI.Page
    {
        ...
        {
            StudentList.Add(new Student("91293239", "Metro", "Le", "CS", "Active"));
            StudentList.Add(new Student("19474783", "Jay", "Chang", "CS", "Active"));
            StudentList.Add(new Student("39390933", "Rick", "Tran", "ENG", "Inactive"));
            StudentList.Add(new Student("19239239", "Mike", "Tran", "CS", "Active"));
